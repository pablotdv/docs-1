...
Standard library file 'file' could not be found  
 ...
 If the file is a [!INCLUDE[vsprvs](../../csharp/includes/vsprvs-md.md)] system file, you may need to repair your [!INCLUDE[vsprvs](../../csharp/includes/vsprvs-md.md)] installation, or reinstall it completely.