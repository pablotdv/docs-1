...
Unsafe code may only appear if compiling with /unsafe  
 ...
 To set the unsafe option in [!INCLUDE[vs_current_long](../../csharp/misc/includes/vs-current-long-md.md)], click on **Project** in the main menu, select the **Build** pane, and check the box that says "allow unsafe code."  
