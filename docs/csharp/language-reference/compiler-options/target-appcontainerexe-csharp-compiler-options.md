...
2.  On the **Application** tab, in the **Output type** list, choose **Windows Store App**.  
     ...
     This option is available only for [!INCLUDE[win8_appname_long](../../../csharp/includes/win8-appname-long-md.md)] app templates.  
