...
The following example shows how to create nested groups in a [!INCLUDE[vbteclinq](../../../csharp/includes/vbteclinq-md.md)] query expression. Each group that is created according to student year or grade level is then further subdivided into groups based on the individuals' names.  
