...
This topic shows the three ways in which you can write a [!INCLUDE[vbteclinq](../../../csharp/includes/vbteclinq-md.md)] query in C#:  
...
3.  Use a combination of query syntax and method syntax.  
 ...
 The following examples demonstrate some simple [!INCLUDE[vbteclinq](../../../csharp/includes/vbteclinq-md.md)] queries by using each approach listed previously. In general, the rule is to use (1) whenever possible, and use (2) and (3) whenever necessary.  
  
> [!NOTE]
>  These queries operate on simple in-memory collections; however, the basic syntax is identical to that used in [!INCLUDE[vbtecdlinq](../../../csharp/includes/vbtecdlinq-md.md)] and [!INCLUDE[sqltecxlinq](../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq-md.md)].  
