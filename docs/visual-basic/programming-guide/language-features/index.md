...
## In This Section  
 ...
 Provides links to topics that introduce [!INCLUDE[vbteclinqext](../../../csharp/getting-started/includes/vbteclinqext-md.md)] features and programming.  
...
## Related Sections  
 ...
 Provides reference information on various aspects of [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] programming.