...
## Inheritance Modifiers  
 [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] introduces the following class-level statements and modifiers to support inheritance:  
