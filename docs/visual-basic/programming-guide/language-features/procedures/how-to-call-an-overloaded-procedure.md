...
3.  You do not have to determine which version of the procedure to call. [!INCLUDE[vbprvb](../../../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] passes control to the version matching your argument list.  
