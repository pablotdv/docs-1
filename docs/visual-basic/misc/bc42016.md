...
-   If possible, use values of the same data type, so [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] does not need to do any conversion.  
