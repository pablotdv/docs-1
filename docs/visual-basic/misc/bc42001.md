...
'Class_Initialize' event is no longer supported. Use 'Sub New' to initialize a class.  
 ...
 The `Class_Initialize` event of previous versions of [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb-md.md)] is replaced by class constructors.  
