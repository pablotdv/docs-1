...
## In This Section  
 ...
 Demonstrates how to use the [!INCLUDE[dnprdnshort](../../../../csharp/getting-started/includes/dnprdnshort-md.md)] to manipulate files and folders.  
