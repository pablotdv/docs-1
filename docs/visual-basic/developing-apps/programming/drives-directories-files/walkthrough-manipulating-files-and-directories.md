...
3.  In the **Name** box, type `FileExplorer` to set the project name, and then click **OK**.  
     ...
     [!INCLUDE[vsprvs](../../../../csharp/includes/vsprvs-md.md)] adds the project to **Solution Explorer**, and the Windows Forms Designer opens.  
